...
export class TaskService {
  ...
  async createManyTasks(): Promise<string> {
    const tasks = [
      ...
      {
        name: 'Leer capítulo de historia',
        description: 'Leer el capítulo 3 del libro de historia para la clase.',
        status: Status.completed,
        defined_time: '1800000',
        redefined_time: '1800000',
        remaining_time: '0',
        started_at: '2024-09-01T09:00:00.000Z',
        completed_at: '2024-09-01T09:30:00.000Z',
      ...
      },
      {
        ...
        description:
          'Practicar acordes y progresiones de guitarra por 30 minutos.',
        status: Status.completed,
        defined_time: '1800000',
        redefined_time: '1800000',
        remaining_time: '0',
        started_at: '2024-09-01T11:00:00.000Z',
        completed_at: '2024-09-01T11:30:00.000Z',
        paused_in: null,
      },
      {
        name: 'Resolver problemas de matemáticas',
        description:
          'Resolver 10 problemas de matemáticas del tema de trigonometría.',
        status: Status.completed,
        defined_time: '3600000',
        redefined_time: '3600000',
        remaining_time: '0',
        started_at: '2024-09-02T08:00:00.000Z',
        completed_at: '2024-09-02T09:00:00.000Z',
        paused_in: null,
      },
      {
        name: 'Practicar dibujo',
        description: 'Dibujar un retrato utilizando lápiz y carbón.',
        status: Status.completed,
        defined_time: '5400000',
        redefined_time: '5400000',
        remaining_time: '1080000',
        started_at: '2024-09-02T14:00:00.000Z',
        completed_at: '2024-09-02T15:18:00.000Z',
        paused_in: null,
      },
      {
        name: 'Preparar presentación',
        description: 'Crear diapositivas para la presentación de biología.',
        status: Status.completed,
        defined_time: '7200000',
        redefined_time: '7200000',
        remaining_time: '0',
        started_at: '2024-09-03T09:00:00.000Z',
        completed_at: '2024-09-03T11:00:00.000Z',
        paused_in: null,
      },
      {
        name: 'Practicar ajedrez',
        description: 'Jugar dos partidas de ajedrez en línea.',
        status: Status.completed,
        defined_time: '2700000',
        redefined_time: '2700000',
        remaining_time: '540000',
        started_at: '2024-09-03T16:00:00.000Z',
        completed_at: '2024-09-03T16:45:00.000Z',
        paused_in: null,
      },
      {
        name: 'Estudiar química',
        description: 'Repasar los elementos de la tabla periódica.',
        status: Status.completed,
        defined_time: '4500000',
        redefined_time: '4500000',
        remaining_time: '900000',
        started_at: '2024-09-04T10:00:00.000Z',
        completed_at: '2024-09-04T11:15:00.000Z',
        paused_in: null,
      },
      {
        name: 'Clases de pintura',
        description: 'Asistir a la clase de acuarela en el centro cultural.',
        status: Status.completed,
        defined_time: '5400000',
        redefined_time: '5400000',
        remaining_time: '0',
      ...
      {
        name: 'Leer novela',
        description: 'Leer 3 capítulos de la novela asignada en clase.',
        status: Status.completed,
        defined_time: '7200000',
        redefined_time: '7200000',
        remaining_time: '1440000',
        started_at: '2024-09-05T09:00:00.000Z',
        completed_at: '2024-09-05T10:36:00.000Z',
        paused_in: null,
      },
      {
        name: 'Escribir ensayo',
        description: 'Redactar el ensayo sobre la Revolución Francesa.',
        status: Status.completed,
        defined_time: '9000000',
        redefined_time: '9000000',
        remaining_time: '1800000',
        started_at: '2024-09-05T13:00:00.000Z',
        completed_at: '2024-09-05T15:30:00.000Z',
        paused_in: null,
      },
      {
        name: 'Estudiar para examen de historia',
        description: 'Revisar notas y libros para el examen de historia.',
        status: Status.completed,
        defined_time: '6000000',
        redefined_time: '6000000',
        remaining_time: '0',
        started_at: '2024-09-06T10:00:00.000Z',
        completed_at: '2024-09-06T11:40:00.000Z',
        paused_in: null,
      },
      {
        name: 'Practicar piano',
        description: 'Practicar escalas y ejercicios en el piano.',
        status: Status.completed,
        defined_time: '3600000',
        redefined_time: '3600000',
        remaining_time: '0',
        started_at: '2024-09-06T15:00:00.000Z',
        completed_at: '2024-09-06T16:00:00.000Z',
        paused_in: null,
      },
      {
        name: 'Proyecto de ciencias',
        description: 'Desarrollar el proyecto de ciencias sobre reciclaje.',
        status: Status.completed,
        defined_time: '7200000',
        redefined_time: '7200000',
        remaining_time: '0',
        started_at: '2024-09-07T08:00:00.000Z',
        completed_at: '2024-09-07T10:00:00.000Z',
        paused_in: null,
      },
      {
        name: 'Clases de baile',
        description: 'Asistir a clases de baile contemporáneo.',
        status: Status.completed,
        defined_time: '4500000',
        redefined_time: '4500000',
        remaining_time: '0',
        started_at: '2024-09-07T11:00:00.000Z',
        completed_at: '2024-09-07T12:15:00.000Z',
        paused_in: null,
      },
      {
        name: 'Revisar apuntes de física',
        description: 'Estudiar los temas de dinámica y estática.',
        status: Status.completed,
        defined_time: '5400000',
        redefined_time: '5400000',
        remaining_time: '1080000',
        started_at: '2024-09-07T13:00:00.000Z',
        completed_at: '2024-09-07T14:18:00.000Z',
        paused_in: null,
      },
      {
        name: 'Jugar videojuegos',
        description: 'Jugar videojuegos de estrategia por una hora.',
        status: Status.completed,
        defined_time: '3600000',
        redefined_time: '3600000',
        remaining_time: '0',
        started_at: '2024-09-07T16:00:00.000Z',
        completed_at: '2024-09-07T17:00:00.000Z',
        paused_in: null,
      },
      {
        name: 'Tocar guitarra',
      ...
      {
        name: 'Limpiar habitacion',
        description: 'Limpiar habitacion',
        status: Status.completed,
        defined_time: '3600000',
        redefined_time: '3600000',
        remaining_time: '0',
        started_at: '2024-09-08T16:00:00.000Z',
        completed_at: '2024-09-08T17:00:00.000Z',
        paused_in: null,
      },
      {
        name: 'Jugar videojuegos',
        description: 'Jugar videojuegos de aventura por una hora.',
        status: Status.completed,
        defined_time: '3600000',
        redefined_time: '3600000',
        remaining_time: '0',
